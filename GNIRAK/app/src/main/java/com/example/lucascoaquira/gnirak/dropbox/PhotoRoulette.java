 ...
 */
public class PhotoRoulette extends Fragment {
    private static final String TAG = "PhotoRoulette";
    ...
    // Obfuscation is good.
    private static final String APP_KEY = "918vrojq43u2dgg";
    private static final String APP_SECRET = "zdif5dcwkemj1hy";
    ...
    private final String PHOTO_DIR = "/Karing/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        photoView = inflater.inflate(R.layout.photo_roulette, container, false);
      ...
      /*  mPhoto = (ImageButton) photoView.findViewById(R.id.btnCamera);
        ...
        mPhoto.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Log.i(TAG, "Importando nueva imagen: " + mCameraFileName);
                try {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == NEW_PICTURE) {
            ...
            if (resultCode == FragmentActivity.RESULT_OK) {
                ...
                if (uri != null) {
                    UploadImage upload = new UploadImage(photoView.getContext(), mApi, PHOTO_DIR, file);
                    upload.execute();
                }
            } else {
    ...
    private void checkAppKeySetup() {
        ...
        if (APP_KEY.startsWith("CHANGE") ||
            ...
            showToast("You must apply for an app key and secret from developers.dropbox.com, and add them to the PhotoRoulette ap before trying it.");
            getActivity().finish();
            return;
        }
    ...
    private void showToast(String msg) {
        Toast error = Toast.makeText(photoView.getContext(), msg, Toast.LENGTH_LONG);
        error.show();
    }
